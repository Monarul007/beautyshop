...
<body>
	...
	<div id="page-wrap">
        <button onclick="window.print()" style="padding: 10px;">Print Invoice</button>
		<textarea id="header">INVOICE</textarea>
		
		<div class="row mb-5">
            <div class="col-7">
                <h3>BeautyShop Inc.</h3>
                <span><b>Address</b> 130 Lammas Street, GREAT BRICETT - IP7 9DY</span> <br>
                <span><b>Phone:</b> +0123456789</span> <br>
                <span><b>E-mail:</b> hello@beautyshop.com</span>
            </div>
		...
		<div class="order-table table-responsive">
            ...
            <tr class="item-row">
                ...
                <td class="description">{{$ordD->name}} <br> <span>{{$ordD->filter}}: {{$ordD->filter_value}}</span></td>
        ...
        <div class="mt-2 mb-5 text-center text-info">Prepared by : <a class="" target="_blank" href="{{ route('home') }}">BeautyShop</a></div>
	</div>
</body>
