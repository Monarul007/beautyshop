    ...
    <section class="category-section">
		<div class="container">
			...
			<div class="page-top-info">
				<div class="breadcrumb"> &nbsp;<a href="{{ route('home') }}">Home&nbsp;</a> » &nbsp; Order Details</div>
			</div>
			<!-- Page info end -->
            <div class="row mb-5">
                <div class="col-lg-3 p1 pr-1">
                    <div class="breadcrumb">
                        ...
                        ?>
                            ...
                            <div class="buttons">
                                <a href="{{ route('useraccount')}}" class="flw">Go To Account Settings</a>
                                <a href="{{ route('shop')}}" class="msg">Go to shop</a>
                            </div>
                            <div class="mgtp-20">
                                <table class="table table-sm table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 11px;"><span class="badge badge-success">{{$user_info->status}}</span></td>
                                    </tr>
                                    <tr>
                                        <td>Total Orders</td>
                                        <td><?= $ordCount; ?></td>
